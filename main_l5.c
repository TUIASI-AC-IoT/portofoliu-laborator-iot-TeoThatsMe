...
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.89.37:5000/firmware.bin" 
...
void start_mdns_service()
{
    ...
    //set hostname
    mdns_hostname_set("esp32-iurascu");
    
    esp_ip4_addr_t addr;
    addr.addr = 0;
    while(1) {
        esp_err_t err = mdns_query_a("esp32-chirica",5000,&addr);
        if(err){
